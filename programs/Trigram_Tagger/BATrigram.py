import nltk, timeit
from nltk.tag import TrigramTagger, BigramTagger, UnigramTagger, DefaultTagger
...
def tagger1():
    ...
    tagger = TrigramTagger(train, backoff=DefaultTagger('NN'))
    def training():
        tagger = TrigramTagger(train, backoff=DefaultTagger('NN'))
    ...
    print("")
    print('Evaluation TrigramTagger, treebank, ambiguous words:')
    print("")
...
def tagger2():
    ...
    taggerWithBackoffChain = backoff_tagger(train2, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    def training():
        taggerWithBackoffChain = backoff_tagger(train2, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
    ...
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation TrigramTagger with backoff chain, treebank, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation TrigramTagger with backoff chain, treebank, unknown words:')
    print("")
...
def tagger3():
    ...
    taggerWithBackoffChain3 = backoff_tagger(train3, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    def training():
        taggerWithBackoffChain3 = backoff_tagger(train3, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
    ...
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation TrigramTagger with backoff chain, brown, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation TrigramTagger with backoff chain, brown, unknown words:')
    print("")
...
def tagger4():
    ...
    taggerWithBackoffChain4 = backoff_tagger(train4, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    def training():
        taggerWithBackoffChain4 = backoff_tagger(train4, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
    ...
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation TrigramTagger with backoff chain, conll, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation TrigramTagger with backoff chain, conll, unknown words:')
    print("")
...
def tagger5():
    ...
    taggerWithBackoffChain5 = backoff_tagger(train5, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    def training():
        taggerWithBackoffChain5 = backoff_tagger(train5, [UnigramTagger, BigramTagger, TrigramTagger], backoff=backoff)
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
    ...
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation TrigramTagger with backoff chain, masc, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation TrigramTagger with backoff chain, masc, unknown words:')
    print("")
