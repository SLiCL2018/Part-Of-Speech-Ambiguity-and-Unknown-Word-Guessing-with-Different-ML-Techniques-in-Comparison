...
from nltk.corpus import brown,conll2000,masc_tagged
...
def tagger1():
    ...
    print('Perceptron Tagger, treebank, ambiguous words:')
    print("")
    ...
    print("")
    print('"Perceptron Tagger, treebank, unknown words: "')
    print("")
...
def tagger2():
    ...
    tagger2.train(brown.tagged_sents())
    def training():
        tagger2.train(brown.tagged_sents())
    ...
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation PerceptronTagger, brown, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation PerceptronTagger, brown, unknown words:')
    print("")
...
def tagger3():
    ...
    tagger3.train(conll2000.tagged_sents())
    def training():
        tagger3.train(conll2000.tagged_sents())
    print("Time to train: ", timeit.timeit(training,number=1))
    def tagging1():
    ...
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation PerceptronTagger, conll, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation PerceptronTagger, conll, unknown words:')
    print("")
...
def tagger4():
    tagger4 = PerceptronTagger(load=False)
    tagger4.train(masc_tagged.tagged_sents()[0:1592])
    def training():
        tagger4.train(masc_tagged.tagged_sents()[0:1592])
    print("Time to train: ", timeit.timeit(training,number=1))
    def tagging1():
    ...
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation PerceptronTagger, masc, ambiguous words:')
    print("")
    ...
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation PerceptronTagger, masc, unknown words:')
    print("")
