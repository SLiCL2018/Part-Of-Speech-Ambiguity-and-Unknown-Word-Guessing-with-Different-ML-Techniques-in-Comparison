...
def tagger1():
    ...
    print("")
    print('Evaluation ClassifierBasedPOSTagger, treebank, ambiguous words:')
    print("")
    ...
    print("")
    print('Evaluation ClassifierBasedPOSTagger, treebank, unknown words:')
    print("")
...
def tagger2():
    train_sents2 = brown.tagged_sents()
    tagger2 = ClassifierBasedPOSTagger(train=train_sents2)
    def training():
        tagger2 = ClassifierBasedPOSTagger(train=train_sents2)
    print("Time to train: ", timeit.timeit(training,number=1))
    def tagging1():
        tagger2.tag(textambig)
    print("Time to tag ambig: ", timeit.timeit(tagging1, number=1))
    def tagging2():
        tagger2.tag(textnewwords)
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, brown, ambiguous words:')
    print("")
    print(tagger2.tag(textambig))
    print("")
    print('accuracy: ', tagger2.evaluate(textambigGoldStandardBrown))
    gold = [str(tag) for sentence in textambigGoldStandardBrown for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger2.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, brown, unknown words:')
    print("")
    print(tagger2.tag(textnewwords))
    print("")
    print('accuracy: ', tagger2.evaluate(textnewwordsGoldStandardBrown))
    gold = [str(tag) for sentence in textnewwordsGoldStandardBrown for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger2.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")

def tagger3():
    train_sents3 = conll2000.tagged_sents()
    tagger3 = ClassifierBasedPOSTagger(train=train_sents3)
    def training():
        tagger3 = ClassifierBasedPOSTagger(train=train_sents3)
    print("Time to train: ", timeit.timeit(training,number=1))
    def tagging1():
        tagger3.tag(textambig)
    print("Time to tag ambig: ", timeit.timeit(tagging1, number=1))
    def tagging2():
        tagger3.tag(textnewwords)
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, conll, ambiguous words:')
    print("")
    print(tagger3.tag(textambig))
    print("")
    print('accuracy: ', tagger3.evaluate(textambigGoldStandard))
    gold = [str(tag) for sentence in textambigGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger3.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, conll, unknown words:')
    print("")
    print(tagger3.tag(textnewwords))
    print("")
    print('accuracy: ', tagger3.evaluate(textnewwordsGoldStandard))
    gold = [str(tag) for sentence in textnewwordsGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger3.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")

def tagger4():
    train_sents4 = masc_tagged.tagged_sents()
    tagger4 = ClassifierBasedPOSTagger(train=train_sents4)
    def training():
        tagger4 = ClassifierBasedPOSTagger(train=train_sents4)
    print("Time to train: ", timeit.timeit(training,number=1))
    def tagging1():
        tagger4.tag(textambig)
    print("Time to tag ambig: ", timeit.timeit(tagging1, number=1))
    def tagging2():
        tagger4.tag(textnewwords)
    print("Time to tag unknown: ", timeit.timeit(tagging2, number=1))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, masc, ambiguous words:')
    print("")
    print(tagger4.tag(textambig))
    print("")
    print('accuracy: ', tagger4.evaluate(textambigGoldStandard))
    gold = [str(tag) for sentence in textambigGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger4.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation ClassifierBasedPOSTagger, masc, unknown words:')
    print("")
    print(tagger4.tag(textnewwords))
    print("")
    print('accuracy: ', tagger4.evaluate(textnewwordsGoldStandard))
    gold = [str(tag) for sentence in textnewwordsGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(tagger4.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
