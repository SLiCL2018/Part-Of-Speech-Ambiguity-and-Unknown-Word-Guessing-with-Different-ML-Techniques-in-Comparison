...
# use a default tagger to test it on unknown words since NN is the most occurring pos tag
default = DefaultTagger('NN')

# test the tagger on sentences
...
def tagger():
    ...
    print("")
    print('Evaluation UnigramTagger, treebank, ambiguous words:')
    print("")
    ...
    print("")
    print('Evaluation UnigramTagger, treebank, unknown words:')
    print("")
...
def tagger1():
    train = treebank.tagged_sents()
    taggerwithbackoff = UnigramTagger(train, backoff=default)
    def training():
        tagger = UnigramTagger(train, backoff=DefaultTagger('NN'))
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
        taggerwithbackoff.tag(textambig)
    print("Time to tag ambiguous words: ", timeit.timeit(tag1, number=1))
    def tag2():
        taggerwithbackoff.tag(textnewwords)
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation UnigramTagger with backoff, treebank, ambiguous words:')
    print("")
    print(taggerwithbackoff.tag(textambig))
    print("")
    print('accuracy: ', taggerwithbackoff.evaluate(textambigGoldStandard))
    gold = [str(tag) for sentence in textambigGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation UnigramTagger with backoff, treebank, unknown words:')
    print("")
    print(taggerwithbackoff.tag(textnewwords))
    print("")
    print('accuracy: ', taggerwithbackoff.evaluate(textnewwordsGoldStandard))
    gold = [str(tag) for sentence in textnewwordsGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")

def tagger2():
    train2 = brown.tagged_sents()
    taggerwithbackoff2 = UnigramTagger(train2, backoff=default)
    def training():
        tagger2 = UnigramTagger(train2, backoff=DefaultTagger('NN'))
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
        taggerwithbackoff2.tag(textambig)
    print("Time to tag ambiguous words: ", timeit.timeit(tag1, number=1))
    def tag2():
        taggerwithbackoff2.tag(textnewwords)
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation UnigramTagger with backoff, brown, ambiguous words:')
    print("")
    print(taggerwithbackoff2.tag(textambig))
    print("")
    print('accuracy: ', taggerwithbackoff2.evaluate(textambigGoldStandardBrown))
    gold = [str(tag) for sentence in textambigGoldStandardBrown for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff2.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation UnigramTagger with backoff, brown, unknown words:')
    print("")
    print(taggerwithbackoff2.tag(textnewwords))
    print("")
    print('accuracy: ', taggerwithbackoff2.evaluate(textnewwordsGoldStandardBrown))
    gold = [str(tag) for sentence in textnewwordsGoldStandardBrown for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff2.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))


def tagger3():
    train3 = conll2000.tagged_sents()
    taggerwithbackoff3 = UnigramTagger(train3, backoff=default)
    def training():
        tagger3 = UnigramTagger(train3, backoff=DefaultTagger('NN'))
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
        taggerwithbackoff3.tag(textambig)
    print("Time to tag ambiguous words: ", timeit.timeit(tag1, number=1))
    def tag2():
        taggerwithbackoff3.tag(textnewwords)
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation UnigramTagger with backoff, conll, ambiguous words:')
    print("")
    print(taggerwithbackoff3.tag(textambig))
    print("")
    print('accuracy: ', taggerwithbackoff3.evaluate(textambigGoldStandard))
    gold = [str(tag) for sentence in textambigGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff3.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation UnigramTagger with backoff, conll, unknown words:')
    print("")
    print(taggerwithbackoff3.tag(textnewwords))
    print("")
    print('accuracy: ', taggerwithbackoff3.evaluate(textnewwordsGoldStandard))
    gold = [str(tag) for sentence in textnewwordsGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff3.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")


def tagger4():
    train4 = masc_tagged.tagged_sents()
    taggerwithbackoff4 = UnigramTagger(train4, backoff=default)
    def training():
        tagger4 = UnigramTagger(train4, backoff=DefaultTagger('NN'))
    print("Time to train: ", timeit.timeit(training, number=1))
    def tag1():
        taggerwithbackoff4.tag(textambig)
    print("Time to tag ambiguous words: ", timeit.timeit(tag1, number=1))
    def tag2():
        taggerwithbackoff4.tag(textnewwords)
    print("Time to tag unknown words: ", timeit.timeit(tag2, number=1))
    print("")
    print('Evaluation UnigramTagger with backoff, masc, ambiguous words:')
    print("")
    print(taggerwithbackoff4.tag(textambig))
    print("")
    print('accuracy: ', taggerwithbackoff4.evaluate(textambigGoldStandard))
    gold = [str(tag) for sentence in textambigGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff4.tag(textambig)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
    print('Evaluation UnigramTagger with backoff, masc, unknown words:')
    print("")
    print(taggerwithbackoff4.tag(textnewwords))
    print("")
    print('accuracy: ', taggerwithbackoff4.evaluate(textnewwordsGoldStandard))
    gold = [str(tag) for sentence in textnewwordsGoldStandard for token, tag in sentence]
    pred = [str(tag) for sentence in zip(taggerwithbackoff4.tag(textnewwords)) for token, tag in sentence]
    print(metrics.classification_report(gold, pred))
    print("")
